...
class LibTest(TestCase):
    def setUp(self):
        ...
        self.c1 = Car.objects.create(
            id="C1", make="test_make", model="test_model", branch=self.b1
        )
        self.c2 = Car.objects.create(
            id="C2", make="test_make", model="test_model", branch=self.b1
        )
        self.c3 = Car.objects.create(
            id="C3", make="test_make", model="test_model", branch=self.b1
        )
    ...
    def test_get_inventory_basic(self, mock_now):
        ...
        inventory = get_inventory_at_date(
            self.b1, parse_datetime("2025-01-05 00:00:00")
        )
    ...
    def test_get_inventory_empty(self, mock_now):
        ...
        inventory = get_inventory_at_date(
            self.b2, parse_datetime("2025-01-05 00:00:00")
        )
    ...
    def test_get_inventory_round_trip(self, mock_now):
        ...
        inventory = get_inventory_at_date(
            self.b1, parse_datetime("2025-02-03 05:00:00")
        )
    ...
    def test_get_inventory_halfway_end(self, mock_now):
        ...
        b1_inventory = get_inventory_at_date(
            self.b1, parse_datetime("2025-02-04 05:00:00")
        )
        b2_inventory = get_inventory_at_date(
            self.b2, parse_datetime("2025-02-04 05:00:00")
        )
    ...
    def test_get_free_cars_normal(self, mock_now):
        ...
        available = get_free_car_ids(
            self.b1,
            parse_datetime("2025-01-05 00:00:00"),
            parse_datetime("2025-01-06 00:00:00"),
        )
    ...
    def test_get_free_cars_overlapping_schedules(self, mock_now):
        ...
        available = get_free_car_ids(
            self.b1,
            parse_datetime("2025-02-02 00:00:00"),
            parse_datetime("2025-02-06 00:00:00"),
        )
