...
class BranchInventoryAPITests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.c3 = Car.objects.create(
            id="C3", make="test_make", model="test_model", branch=self.b2
        )
    ...
    def test_get_inventory(self, mock_now):
        expected = [
            {"id": "C1", "make": "test_make", "model": "test_model", "branch": 1},
    ...
    def test_post_inventory(self, mock_now):
        ...
        b1_response = self.client.post(
            "/api/branches/1/inventory", {"at_time": "2025-02-09"}, format="json"
        )
        b2_response = self.client.post(
            "/api/branches/2/inventory", {"at_time": "2025-02-09"}, format="json"
        )
