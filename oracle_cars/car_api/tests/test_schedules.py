...
class ScheduleObjectTests(TestCase):
    def setUp(self):
        ...
        self.c1 = Car.objects.create(
            id="C1", make="Honda", model="Accord", branch=self.branch
        )
        self.c2 = Car.objects.create(
            id="C2", make="Honda", model="Accord", branch=self.branch
        )
...
class ScheduleAPITests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.c1 = Car.objects.create(
            id="C1", make="Honda", model="Accord", branch=self.b1
        )
        self.c2 = Car.objects.create(
            id="C2", make="Ford", model="Falcon", branch=self.b1
        )
        ...
        self.s3 = Schedule.objects.create(
            start_time="2025-11-29 00:00:00",
...
class ScheduleGetTests(ScheduleAPITests):
    def test_get_all_schedules(self):
        expected_data = [
            ...
            {
                "id": 2,
                "start_time": "2025-02-04T00:00:00",
                "end_time": "2025-02-07T00:00:00",
                "car_id": "C2",
                "origin_branch": 1,
                "destination_branch": 1,
            ...
            {
                "id": 3,
                "start_time": "2025-11-29T00:00:00",
...
class SchedulePostTests(ScheduleAPITests):
    def test_post_basic(self, mock_now):
        ...
        expected_data = {
            "id": 4,
            "start_time": "2025-01-05T00:00:00",
            "end_time": "2025-01-05T05:00:00",
            "car_id": "C1",
            "origin_branch": self.b1.id,
            "destination_branch": self.b1.id,
        }

        response = self.client.post("/api/schedules/", data=data, format="json")
        self.assertEqual(response.data, expected_data)
    ...
    def test_post_bad_start_time(self, mock_now):
        ...
        expected_response = {"error": "timeframe could not be parsed properly."}
